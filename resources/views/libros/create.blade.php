        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2><i class="fas fa-plus me-2"></i>Agregar Libro</h2>
                        ...
                        <form method="POST" action="{{ route('libros.store') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="isbn" name="isbn"
                                            value="{{ old('isbn') }}" placeholder="978-84-123456-7-8">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="numero_paginas"
                                            name="numero_paginas" value="{{ old('numero_paginas') }}" min="1">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="cantidad_total"
                                            name="cantidad_total" value="{{ old('cantidad_total', 1) }}" min="1"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="resumen" name="resumen" rows="4"
                                    placeholder="Breve descripción del contenido del libro">{{ old('resumen') }}</textarea>
                            </div>
